...
const SECTION_ALIASES: Record<string, string> = {
  ...
  competitor_entity: 'competitor_entities',
  competitor_entities: 'competitor_entities',
  competitor_brand: 'competitor_entities',
  competitor_brands: 'competitor_entities',
  competitor_account: 'competitor_accounts',
  competitor_accounts: 'competitor_accounts',
  competitor_handle: 'competitor_accounts',
  competitor_handles: 'competitor_accounts',
